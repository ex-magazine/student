  ...
  return (    
    <Box className={classes.root}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6} lg={3}>
          <StatisticItem icon={<LinearScale fontSize="large" color="primary" />} label="mark >= 5" value={statistics.lowMarkCount} />
        </Grid>
      </Grid>
      ...
      <Box mt={5}>
       ...
       {/**Ranking by city*/}
       <Box mt={5}>
        <Typography variant="h4">Rangking by City</Typography>
        <Box mt={2}>
          <Grid container spacing={3}>
